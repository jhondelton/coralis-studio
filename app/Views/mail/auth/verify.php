                        ...
                        <table class="inner-body table-3" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                                <td class="content-cell td-4">
                                    ...
                                    <p class="p">
                                        Silahkan untuk mengklik Tombol "Verifikasi Akun" dibawah ini, untuk mengaktifkan akun Anda.
                                    </p>
                                    ...
                                    <table class="subcopy table-7" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            <td class="td-6">
                                                ...
                                                Jika Anda mengalami masalah saat mengklik tombol "Verifikasi Akun", salin dan tempel URL di bawah ini ke browser web Anda:
                                                    <span>
