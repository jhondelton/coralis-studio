    ...
    <div class="col-lg-7">
        <div class="card">
            <div class="card-header bg-primary">
                <h3 class="card-title m-0 text-white">Daftar</h3>
            </div>
            <div class="card-body">
                <div class="">
                    <form method="post" action="<?= base_url('auth/register') ?>" id="input_form">
                        <?= csrf_field() ?>
                        <div class="form-group">
                            <label class="form-label">Nama Lengkap <text class="text-danger">*</text></label>
